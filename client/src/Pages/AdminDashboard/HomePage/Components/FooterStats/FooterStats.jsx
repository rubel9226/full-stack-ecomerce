...
const FooterStats = () => {
    return (
        <div className='text-white bg-linear-to-b from-[#215DA1] via-[#4762AA] via-50% to-[#5261AE] py-6 sm:rounded-md lg:rounded-xl'>
            ...
            <div className='flex flex-col justify-enter items-center'>
                <div className='text-center'>
                    ...
                    <h3 className='font-semibold md:font-bold text-base sm:text-xl md:text-2xl lg:text-3xl 2xl:text-4xl uppercase'>become our corporate partner</h3>
                </div>

                <div className="grid grid-cols-2 lg:grid-cols-4 lg:gap-24 my-6 lg:my-12 justify-center text-center gap-5">
                    <div className="">
