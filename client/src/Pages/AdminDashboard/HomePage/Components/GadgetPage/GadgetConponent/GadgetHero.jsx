...
export default function GadgetHero() {
  const datas = [
    ...
    { img: '/src/assets/men.avif', description: 'Lorem ipsum 1this product is vary dengarus. and I also love this product and we go this product area.0'},
  ];
        ...
        <div className="flex gap-3  overflow-x-auto no-scrollbar">
            {datas.map((data, index) => (
                <div key={index} className="text-center shrink-0">
                  <img className="w-[288px] lg:w-[28vw] max-w-[588px] aspect-[2] mx-auto rounded-xl" src={data.img} alt="" />
                  <p>{data.name}</p>
                </div>
            ))}       
        </div>
