  ...
  <div>
    ...
    <div className="py-7 px-5">
      ...
      <div className="text-center pt-2">
        <Link to={'/'} className="text-3xl font-bold text-[#1F5DA0]">
          Thrivon Fashion
        </Link>
      </div>
    </div>
    ...
    <div className="w-full max-w-md border border-gray-200 p-8 rounded-xl shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* 🔥 Forgot Password (PERFECT POSITION) */}
        <div className="flex justify-end -mt-2">
          <Link
            to="/forgot-password"
            className="text-sm text-[#1F5DA0] hover:underline"
          >
            Forgot password?
          </Link>
        </div>
      ...
      <p className="text-center text-[15px] text-black/50 font-medium mt-4">
        ...
        <Link
          to={'/register'}
          className="hover:link text-black font-medium cursor-pointer"
        >
          Sign up
        </Link>
      </p>
