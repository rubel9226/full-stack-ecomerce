...
export default function Offer24() {
  ...
  return (
    <section className="select-none bg-[url('https://res.cloudinary.com/dext9i4ab/image/upload/v1780523844/offer-bg_fhhz3p.webp')] bg-cover bg-center w-full mt-5 md:rounded-2xl">
