...
const Gadget = () => {
    ...
    return (
        <div className=''>
            ...
            <div className=' py-6 mt-2 md:mt-4 lg:mt-6 '>

                <div className='bg-[#F1F5F9] px-5 pt-6 mb-4 md:mb-6 lg:pb-1'>
                    <div className='lg:flex items-center justify-between'>
                        <div className='lg:flex items-center '>
                            <h2 className='font-semibold text-center text-xl md:text-2xl xl:text-3xl 2xl:text-[32px] capitalize '>Trending Now</h2>

                            <div className='flex gap-2 md:justify-center sm:gap-3 overflow-x-auto no-scrollbar scroll-smooth mt-2 pb-1 lg:ml-5'>
                        ...
                        {/* Button */}
                        <div className='text-center justify-center hidden lg:flex'>
                            <div className='text-blue-800/90'>
                                <Link to={
                                    activeButton === 'bags&luggage' ? 'catalog/bags-and-luggage' : 
                                    activeButton === 'watch' ? 'catalog/watch' : 
                                    activeButton === 'shave&trim' ? 'catalog/shave-and-trim' : 
                                    activeButton === 'headphone' ? 'catalog/headphones' : ''
                                } className='text-sm font-semibold md:text-base xl:text-xl flex items-center gap-0.5 md:gap-1 cursor-pointer'> 
                                    See More 
