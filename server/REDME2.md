...
## Course plan 
 ...
 7. Middleware
 8. Express Error Handling Middleware --> express/body-parser
 ...
 21. Refactoring & reusability, dynamically
 22. deleteImage helper
 23. POST /api/users/process-register -> process the register
 24. Create JWT
 25. setup smtp server & prepare email
 26. send email with nodemailer
 27. POST /api/users/verify -> verify + registration database
 ...
 31. should we store image as string.
 ...
 43. GET /api/auth/refresh-token -> genarate refresh tohe token
